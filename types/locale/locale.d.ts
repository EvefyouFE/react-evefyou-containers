...
export declare function formatContainersMessage({ id, values }: Props): React.ReactNode;
export declare function formatContainersById(id: Id, values?: Values): React.ReactNode;
export {};
